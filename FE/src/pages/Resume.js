...
function Resume() {
            ...
            <>
              <details className="det">
                ...
                <input
                  ...
                  onChange={(event) => handleexppos(event, index)}
                  value={exp.position}
                ></input>
                <input
                  className="inputfield"
                  ...
                  onChange={(event) => handleexpcomp(event, index)}
                  value={exp.compname}
                ></input>
                <div style={{ display: "flex" }}>
                  <input
                    ...
                    placeholder="start"
                    type="number"
                    onChange={(event) => handleexpstart(event, index)}
                    value={exp.startdate}
                  ></input>
                  &nbsp;&nbsp;&nbsp;-&nbsp;
                  <input
                    ...
                    placeholder="end"
                    type="number"
                    onChange={(event) => handleexpend(event, index)}
                    value={exp.enddate}
                  ></input>
                </div>
                <input
                  ...
                  type="text"
                  placeholder="Details"
                  onChange={(event) => handleexpdet(event, index)}
                  value={exp.details}
                ></input>
                <button
                  className="delbut"
                  onClick={(event) => handledelexp(event, index)}
                >
                  x
                </button>
              </details>
    ...
    <>
      ...
      <button
        ...
        onClick={() => {
          setEducation([
            ...education,
            { school: "", startdate: "", enddate: "", details: "" },
          ]);
        }}
      >
        +
      ...
      <div className="contentshower">
        {education.map(function (schl, index) {
          return (
            <>
              <details className="det">
                ...
                <input
                  ...
                  onChange={(event) => handleeduschool(event, index)}
                  value={schl.school}
                ></input>
                <div style={{ display: "flex" }}>
                  <input
                    ...
                    placeholder="start"
                    type="number"
                    onChange={(event) => handleedustart(event, index)}
                    value={schl.startdate}
                  ></input>
                  &nbsp;&nbsp;&nbsp;-&nbsp;
                  <input
                    className="smallinputfield"
                    placeholder="end"
                    type="number"
                    onChange={(event) => handleeduend(event, index)}
                    value={schl.enddate}
                  ></input>
                </div>
                <input
                  ...
                  type="text"
                  placeholder="Details"
                  onChange={(event) => handleedudetails(event, index)}
                  value={schl.details}
                ></input>
                <button
                  className="delbut"
                  onClick={(event) => handledeledu(event, index)}
                >
                  x
                </button>
              </details>
          ...
          return (
            <>
              <input
                ...
                onChange={(event) => handleskill(event, index)}
                value={skills[index]}
              ></input>
              <button
                className="delbut"
                onClick={(event) => handledelskill(event, index)}
              ></button>
            </>
          );
        })}
  ...
  const onsubmity = async (e) => {
    ...
    fetch(
      `http://localhost:8080/resume/post/${localStorage.getItem("userId")}`,
      {
        method: "POST",
  ...
  return (
    <>
      <div className="quiz-background">
        <div className="quiz-upper-cont">{pages[index]}</div>
        <div className="quiz-lower-cont">
          ...
          {index === pages.length - 1 && (
            <button className="nextbutton" onClick={onsubmity}>
              Submit
            </button>
          )}
          {index !== 0 && (
